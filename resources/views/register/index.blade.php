...
<div class="container">
    <form class="form-signin" method="POST" action="/register">
        ...
        <input type="text" name="name" id="name" class="form-control" value="{{ old('name') }}" placeholder="名字" autofocus>
        <label for="inputEmail" class="sr-only">邮箱</label>
        <input type="email" name="email" id="inputEmail" class="form-control" value="{{ old('email') }}" placeholder="邮箱" autofocus>
